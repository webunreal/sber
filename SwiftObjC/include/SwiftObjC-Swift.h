...
#ifndef SWIFTOBJC_SWIFT_H
#define SWIFTOBJC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftObjC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SwiftObjC11AppDelegate")
...
SWIFT_CLASS("_TtC9SwiftObjC13SceneDelegate")
...
SWIFT_CLASS("_TtC9SwiftObjC14ViewController")
